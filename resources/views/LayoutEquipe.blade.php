            ...
            <span class="avatar avatar-sm mt-2">
              <img src="{{ asset('Bika/assets/avatars/face-1.jpg') }}" alt="..." class="avatar-img rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="{{url('LogOut/equipe')}}"><i class="fe fe-power"></i> Log Out</a>
                </div>
            </li>
        </ul>
    </nav>
    <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
            ...
            <div class="w-100 mb-4 d-flex">
                <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="{{ url('equipe/accueil') }}">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{url('classement/equipe/getEtapeClient')}}"><span class="ml-1 item-text">Classement  coureur/étape</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ url('classement/equipe/classementParEquipe') }}"><span class="ml-1 item-text">Classement Générale par Equipe</span></a>
                        </li>
